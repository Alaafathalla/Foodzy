      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-500 dark:text-gray-400">
            Manage your details and keep track of every Foodzy order.
          </p>
        </div>
        ...
        <div className="grid gap-8 lg:grid-cols-[320px_minmax(0,1fr)]">
          <aside className="h-fit rounded-3xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-800 dark:bg-gray-900">
            <div className="relative mx-auto mb-5 flex h-32 w-32 items-center justify-center rounded-full bg-gradient-to-br from-red-400 to-orange-400 text-white shadow-xl">
              ...
              <button
                type="button"
                className="absolute bottom-1 right-1 flex h-10 w-10 items-center justify-center rounded-full border-4 border-white bg-gray-900 text-white dark:border-gray-900"
            ...
            <h2 className="text-center text-xl font-black text-gray-900 dark:text-white">
              {form.name}
            </h2>
          ...
          <div className="space-y-8">
            ...
            <form
              ...
              className="rounded-3xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-gray-900 sm:p-8"
            >
              <h2 className="mb-7 text-xl font-black text-gray-900 dark:text-white">
              ...
              <div className="mt-8 flex justify-end">
                <button
                  type="submit"
                  className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-red-500 px-6 py-3 font-bold text-white transition hover:bg-red-600 sm:w-auto"
                >
                  <Save size={18} />
                  Save changes
                </button>
                ...
                {recentOrders.map((order) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between gap-4 sm:justify-end">
                      ...
                      <button
                        type="button"
                        className="rounded-lg p-2 text-gray-400 transition hover:bg-gray-100 hover:text-red-500 dark:hover:bg-gray-800"
  ...
  return (
    <div className="rounded-2xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-800 dark:bg-gray-900">
      <div className="flex items-center justify-between">
        ...
        <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-red-50 text-red-500 dark:bg-red-500/10">
          <Icon size={22} />
        </span>
      </div>
    </div>
...
function ActiveOrder({ order }) {
  ...
  return (
    <div className="rounded-2xl border border-gray-100 bg-gray-50 p-4 dark:border-gray-800 dark:bg-gray-800/70">
      <div className="flex items-start justify-between gap-4">
        <span
          className={`flex h-11 w-11 items-center justify-center rounded-xl ${order.tone}`}
        >
          <Icon size={21} />
        </span>
      ...
      <p className="mt-4 font-black text-gray-900 dark:text-white">
        Order #{order.id}
      </p>
...
function Field({ label, ...props }) {
  return (
    <label className="block">
      ...
      <input
        {...props}
        className="w-full rounded-xl border border-gray-200 bg-gray-50 px-4 py-3 text-gray-900 outline-none transition focus:border-red-500 focus:ring-4 focus:ring-red-500/10 dark:border-gray-700 dark:bg-gray-950 dark:text-white"
      />
    </label>
  );
}
